...
console.log(`PASS colors:112 marks,16 groups per panel; path equivalents; RGB4096×16 contrast min text ${minText.toFixed(2)}, border ${minBorder.toFixed(2)}. Source/algorithm only, not browser theme rendering.`);
