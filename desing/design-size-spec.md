...
| Три действия | B | 13 / 13 | W | 1,4; 18,2 |
...
| Действие | min-height28/13B, width по grid; padding выше | Минимум28px, фактически≥28,2px для одной строки | Вся кнопка; missing программно отключён через aria-disabled/guard |
